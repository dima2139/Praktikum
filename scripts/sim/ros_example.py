...
This is a basic example to get you started with using MoveIt in Python. There are many other advanced features and options available, and you can find more information in the official MoveIt documentation: http://docs.ros.org/kinetic/api/moveit_tutorials/html/index.html
